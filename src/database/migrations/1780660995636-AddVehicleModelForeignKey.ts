...
export class AddVehicleModelForeignKey1780660995636 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vehicles" ADD "model_id" uniqueidentifier NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "vehicles" DROP COLUMN "model_id"`);
        await queryRunner.query(`ALTER TABLE "vehicles" ADD "model_id" nvarchar(255) NOT NULL`);
    }
